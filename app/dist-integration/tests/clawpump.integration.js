...
import { createClawpumpFundingPlan, createClawpumpLaunchPlan, executeClawpumpFunding, executeClawpumpLaunch, persistClawpumpLaunchProof, } from '../src/utils/clawpump.js';
const network = {
...
test('executes live Clawpump funding and launch only when explicitly enabled', { skip: process.env.RUN_CLAWPUMP_LIVE !== '1' }, async () => {
